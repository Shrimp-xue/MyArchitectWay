...
<form action="${pageContext.request.contextPath }/store/update" method="post">
    <input type="hidden" name="uuid" value="${storeModel.uuid }"/>
    <table width="100%" border="1" cellpadding="0" cellspacing="1" class="tableLine">
        ...
        <tr>
            <td>商品编号</td>
            <td><input type="text" name="goodsUuid" value="${storeModel.goodsUuid}"></td>
            <td>库存数量</td>
            <td><input type="text" name="storeNum" value="${storeModel.storeNum}"></td>
        </tr>
