...
/**
 * @description: Various character and character sequence utilities, including
 * <code>char[]</code> - <code>byte[]</code> conversions.
 * @author: shrimp
 * @date: Created in 2020-01-11 17:41
 * @version: 1.0
 */
public class CharUtil {
    ...
    public final static byte[] toByteArray(char[] carr) throws UnsupportedEncodingException {
        return new String(carr).getBytes(Constant.UTF_8);
    }
    ...
    public final static char[] toCharArray(byte[] barr) throws UnsupportedEncodingException {
        return new String(barr, Constant.UTF_8).toCharArray();
    }
