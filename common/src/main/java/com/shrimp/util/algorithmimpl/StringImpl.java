...
import com.shrimp.util.SysUtil;
 ...
 * @author: shrimp
 * @date: Created in 2020-01-11 17:50
 * @version: 1.0
 */
public class StringImpl {
    ...
    public static String simpleEncoding(String str) {
        try {
            ...
            if (str.equals(new String(bs, Constant.UTF_8))) {
                return Constant.UTF_8;
            }
            if (str.equals(new String(bs, Constant.GBK))) {
                return Constant.GBK;
            }
            if (str.equals(new String(bs, Constant.ISO_8859_1))) {
                return Constant.ISO_8859_1;
            }
